...
export default function Nav() {
  ...
  const linkClass = scrolled
    ...
    : "text-paper bg-ink/28 border-paper/30 shadow-[0_2px_10px_rgba(0,0,0,0.18)] hover:border-paper hover:bg-paper hover:text-ink"

  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[200] flex items-center justify-between transition-all duration-300 ${
        scrolled ? "bg-paper/92 backdrop-blur-md shadow-[0_1px_0_rgba(42,42,34,0.16)] px-8 py-3.5" : "px-8 py-5"
      }`}
    >
      <a
        href="#top"
        aria-label="Back to top"
        className="w-14 h-14 flex items-center justify-center -rotate-[8deg] transition-transform duration-500 hover:rotate-[10deg] hover:scale-110 flex-shrink-0 drop-shadow-[0_6px_18px_rgba(0,0,0,0.18)]"
      >
